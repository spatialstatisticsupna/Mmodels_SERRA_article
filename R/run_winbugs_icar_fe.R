...
## load functions                                                             ##
################################################################################
source("functions/fe_fe_icar_spaciotemporal_functions.R") # functions (models)
...
save(resulta.winbugs.icar.fe, t.resulta.winbugs.icar.fe, 
     file= paste0("resul/",gsub("\\.", "_", "resulta.winbugs.icar.fe"),".RData"))
################################################################################
################################################################################