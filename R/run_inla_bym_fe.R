...
model.s.u <- inla.rgeneric.define(inla.rgeneric.Mmodel.model.icar, debug = TRUE, k = k, W = W, alpha.min = alpha.min, alpha.max = alpha.max)
...
source("functions/inla_rgeneric_Mmodel_model_iid.R") # iid
model.s.v <- inla.rgeneric.define(inla.rgeneric.Mmodel.model.iid, debug = TRUE, k = k, W = W, alpha.min = alpha.min, alpha.max = alpha.max)
...
## save                               ##
########################################
resulta.inla.bym.fe<- list(bym.ad.fe=bym.ad.fe.fe,
                           bym.t1.fe=bym.t1.fe.fe,
                           bym.t2.fe=bym.t2.fe.fe,
                           bym.t3.fe=bym.t3.fe.fe,
                           bym.t4.fe=bym.t4.fe.fe)
