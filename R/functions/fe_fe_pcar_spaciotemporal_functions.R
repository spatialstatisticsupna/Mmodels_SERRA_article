##################################################################################################
## Spatial: FE (pcar); Temporal: FE (rw1); Spatio-temporal: ad
## FE.FE.ad.pcar
##################################################################################################
FE.FE.ad.pcar <- function(){
...
##################################################################################################
## Spatial: FE (pcar); Temporal: FE (rw1); Spatio-temporal: Type I
## FE.FE.t1.pcar
##################################################################################################
FE.FE.t1.pcar <- function(){
  for (j in 1:Ndiseases){
    for (i in 1:Nareas){
      for(l in 1:Nyears){
        ## Observed of the mean for each area, disease and time
...
##################################################################################################
# Spatial: FE (pcar); Temporal: FE (rw1); Spatio-temporal: Type II
# FE.FE.t2.pcar
##################################################################################################
FE.FE.t2.pcar <- function(){
  for (j in 1:Ndiseases){
    for (i in 1:Nareas){
      for(l in 1:Nyears){
        ## Observed of the mean for each area, disease and time
...
##################################################################################################
## Spatial: FE (pcar); Temporal: FE (rw1); Spatio-temporal: Type III
## FE.FE.t3.pcar
##################################################################################################
FE.FE.t3.pcar <- function(){
  for (j in 1:Ndiseases){
    for (i in 1:Nareas){
      for(l in 1:Nyears){
        ## Observed of the mean for each area, disease and time
...
##################################################################################################
## Spatial: FE (pcar); Temporal: FE (rw1); Spatio-temporal: Type IV
## FE.FE.t4.pcar
##################################################################################################
FE.FE.t4.pcar <- function(){
  for (j in 1:Ndiseases){
    for (i in 1:Nareas){
      for(l in 1:Nyears){
        ## Observed of the mean for each area, disease and time
