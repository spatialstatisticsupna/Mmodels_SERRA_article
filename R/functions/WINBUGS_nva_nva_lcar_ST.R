##################################################################################################
## Spatial: NVA (lcar); Temporal: NVA (rw1); Spatio-temporal: ad
## NVA.NVA.ad.lcar
############################################
NVA.NVA.ad.lcar <- function(){
  ########################################
  for(k in 1:nnv){
...
##################################################################################################
## Spatial: NVA (lcar); Temporal: NVA (rw1); Spatio-temporal: Type I
## NVA.NVA.t1.lcar
##################################################################################################
NVA.NVA.t1.lcar <- function(){
  ########################################
  for(k in 1:nnv){
    for(j in 1:Ndiseases){
      uneigh[j,k]<- Spatial[j, adj[k] ]
...
##################################################################################################
## Spatial: NVA (lcar); Temporal: NVA (rw1); Spatio-temporal: Type II
## NVA.NVA.t2.lcar
##################################################################################################
NVA.NVA.t2.lcar <- function(){
  ########################################
  for(k in 1:nnv){
    for(j in 1:Ndiseases){
      uneigh[j,k]<- Spatial[j, adj[k] ]
...
##################################################################################################
## Spatial: NVA (lcar); Temporal: NVA (rw1); Spatio-temporal: Type III
## NVA.NVA.t3.lcar
##################################################################################################
NVA.NVA.t3.lcar <- function(){
  ########################################
  for(k in 1:nnv){
    for(j in 1:Ndiseases){
      uneigh[j,k]<- Spatial[j, adj[k] ]
...
##################################################################################################
## Spatial: NVA (lcar); Temporal: NVA (rw1); Spatio-temporal: Type IV
## NVA.NVA.t4.lcar
############################################
NVA.NVA.t4.lcar <- function(){
  ########################################
  for(k in 1:nnv){
    for(j in 1:Ndiseases){
      uneigh[j,k]<- Spatial[j, adj[k] ]
