##################################################################################################
## Spatial: NVA (icar); Temporal: NVA (rw1); Spatio-temporal: ad
## NVA.NVA.ad.icar
##################################################################################################
NVA.NVA.ad.icar <- function(){
...
##################################################################################################
## Spatial: NVA (icar); Temporal: NVA (rw1); Spatio-temporal: Type I
## NVA.NVA.t1.icar
##################################################################################################
NVA.NVA.t1.icar <- function(){
  for (j in 1:Ndiseases){
    for (i in 1:Nareas){
      for(l in 1:Nyears){
        ## Observed of the mean for each area, disease and time
...
##################################################################################################
## Spatial: NVA (icar); Temporal: NVA (rw1); Spatio-temporal: Type II
## NVA.NVA.t2.icar
##################################################################################################
NVA.NVA.t2.icar <- function(){
  for (j in 1:Ndiseases){
    for (i in 1:Nareas){
      for(l in 1:Nyears){
        ## Observed of the mean for each area, disease and time
...
##################################################################################################
## Spatial: NVA (icar); Temporal: NVA (rw1); Spatio-temporal: Type III
## NVA.NVA.t3.icar
##################################################################################################
NVA.NVA.t3.icar <- function(){
  for (j in 1:Ndiseases){
    for (i in 1:Nareas){
      for(l in 1:Nyears){
        ## Observed of the mean for each area, disease and time
...
##################################################################################################
## Spatial: NVA (icar); Temporal: NVA (rw1); Spatio-temporal: Type IV
## NVA.NVA.t4.icar
##################################################################################################
NVA.NVA.t4.icar <- function(){
  for (j in 1:Ndiseases){
    for (i in 1:Nareas){
      for(l in 1:Nyears){
        ## Observed of the mean for each area, disease and time
