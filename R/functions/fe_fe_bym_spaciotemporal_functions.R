##################################################################################################
## Spatial: FE (bym); Temporal: FE (rw1); Spatio-temporal: ad
## FE.FE.ad.bym
##################################################################################################
FE.FE.ad.bym <- function(){
...
##################################################################################################
## Spatial: FE (bym); Temporal: FE (rw1); Spatio-temporal: Type I
## FE.FE.t1.bym
##################################################################################################
FE.FE.t1.bym <- function(){
  for (j in 1:Ndiseases){
    for (i in 1:Nareas){
      for(l in 1:Nyears){
        ## Observed of the mean for each area, disease and time
...
##################################################################################################
# Spatial: FE (bym); Temporal: FE (rw1); Spatio-temporal: Type II
# FE.FE.t2.bym
##################################################################################################
FE.FE.t2.bym <- function(){
  for (j in 1:Ndiseases){
    for (i in 1:Nareas){
      for(l in 1:Nyears){
        ## Observed of the mean for each area, disease and time
  ...
  ##################
  for (j in 1:(Ndiseases)){
    Temporal[j, 1:Nyears] ~ car.normal(adjt[], weightst[], numt[],1) # strucutred
    for (l in 1:Nyears){
      tPhiG[j,l] <-Temporal[j,l]
    }
  }
...
##################################################################################################
## Spatial: FE (bym); Temporal: FE (rw1); Spatio-temporal: Type III
## FE.FE.t3.bym
##################################################################################################
FE.FE.t3.bym <- function(){
  for (j in 1:Ndiseases){
    for (i in 1:Nareas){
      for(l in 1:Nyears){
        ## Observed of the mean for each area, disease and time
...
##################################################################################################
## Spatial: FE (bym); Temporal: FE (rw1); Spatio-temporal: Type IV
## FE.FE.t4.bym
##################################################################################################
FE.FE.t4.bym <- function(){
  for (j in 1:Ndiseases){
    for (i in 1:Nareas){
      for(l in 1:Nyears){
        ## Observed of the mean for each area, disease and time
