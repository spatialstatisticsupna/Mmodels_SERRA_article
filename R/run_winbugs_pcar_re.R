...
## load functions                                                             ##
################################################################################
source("functions/WINBUGS_nva_nva_pcar_ST.R")
...
results.nva.nva.pcar.ad <- result 
t.results.nva.nva.pcar.ad <- t.result
...
results.nva.nva.pcar.t1 <- result 
t.results.nva.nva.pcar.t1 <- t.result
...
results.nva.nva.pcar.t2 <- result 
t.results.nva.nva.pcar.t2 <- t.result
...
results.nva.nva.pcar.t3 <- result 
t.results.nva.nva.pcar.t3 <- t.result
...
results.nva.nva.pcar.t4 <- result 
t.results.nva.nva.pcar.t4 <- t.result
...
## Save results                       ##
########################################
results.winbugs.pcar.re<- list(pcar.ad.re=results.nva.nva.pcar.ad,
                               pcar.t1.re=results.nva.nva.pcar.t1,
                               pcar.t2.re=results.nva.nva.pcar.t2,
                               pcar.t3.re=results.nva.nva.pcar.t3,
                               pcar.t4.re=results.nva.nva.pcar.t4)

t.results.winbugs.pcar.re<- list(pcar.ad.re=t.results.nva.nva.pcar.ad,
                                 pcar.t1.re=t.results.nva.nva.pcar.t1,
                                 pcar.t2.re=t.results.nva.nva.pcar.t2,
                                 pcar.t3.re=t.results.nva.nva.pcar.t3,
                                 pcar.t4.re=t.results.nva.nva.pcar.t4)

save(results.winbugs.pcar.re, t.results.winbugs.pcar.re,
     file=paste0("results/",gsub("\\.", "_", "results.winbugs.pcar.re"),".RData"))
