...
## load functions                                                             ##
################################################################################
source("functions_WinBUGS/nva_nva_pcar_spaciotemporal_functions.R") # functions (models)
...
## save                               ##
########################################
resulta.winbugs.pcar.re<- list(pcar.ad.re=resulta.nva.nva.pcar.ad,
                               pcar.t1.re=resulta.nva.nva.pcar.t1,
                               pcar.t2.re=resulta.nva.nva.pcar.t2,
                               pcar.t3.re=resulta.nva.nva.pcar.t3,
                               pcar.t4.re=resulta.nva.nva.pcar.t4)

t.resulta.winbugs.pcar.re<- list(pcar.ad.re=t.resulta.nva.nva.pcar.ad,
                                 pcar.t1.re=t.resulta.nva.nva.pcar.t1,
                                 pcar.t2.re=t.resulta.nva.nva.pcar.t2,
