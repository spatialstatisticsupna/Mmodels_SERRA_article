...
## load functions                                                             ##
################################################################################
source("functions/WINBUGS_nva_nva_lcar_ST.R")
...
results.nva.nva.lcar.ad <- result 
t.results.nva.nva.lcar.ad <- t.result
...
results.nva.nva.lcar.t1 <- result 
t.results.nva.nva.lcar.t1 <- t.result
## rm
rm(list = c("cl", "initials", "param", "result", "t.result"))
rm("data")
...
results.nva.nva.lcar.t2 <- result 
t.results.nva.nva.lcar.t2 <- t.result
...
results.nva.nva.lcar.t3 <- result 
t.results.nva.nva.lcar.t3 <- t.result
...
results.nva.nva.lcar.t4 <- result 
t.results.nva.nva.lcar.t4 <- t.result
## rm
rm(list = c("cl", "initials", "param", "result", "t.result"))
rm("data")
...
## Save results                       ##
########################################
results.winbugs.lcar.re <- list(lcar.ad.re=results.nva.nva.lcar.ad,
                               lcar.t1.re=results.nva.nva.lcar.t1,
                               lcar.t2.re=results.nva.nva.lcar.t2,
                               lcar.t3.re=results.nva.nva.lcar.t3,
                               lcar.t4.re=results.nva.nva.lcar.t4)

t.results.winbugs.lcar.re <- list(lcar.ad.re=t.results.nva.nva.lcar.ad,
                                 lcar.t1.re=t.results.nva.nva.lcar.t1,
                                 lcar.t2.re=t.results.nva.nva.lcar.t2,
                                 lcar.t3.re=t.results.nva.nva.lcar.t3,
                                 lcar.t4.re=t.results.nva.nva.lcar.t4)

save(results.winbugs.lcar.re, t.results.winbugs.lcar.re, 
     file=paste0("results/",gsub("\\.", "_", "results.winbugs.lcar.re"),".RData"))
